...
//    bankAccount = wireArray[1];
//    BILL10 = wireArray[2].toInt();
//    BILL20 = wireArray[3].toInt();
//    BILL50 = wireArray[4].toInt();
//    transNR = wireArray[5];
//    wantsReceipt = wireArray[6].toInt();

  while(Wire.available() > 0){
    dateTime = Wire.read();
    bankAccount = Wire.read();
    BILL10 = Wire.read();
    BILL20 = Wire.read();
    BILL50 = Wire.read();
    transNR= Wire.read();
