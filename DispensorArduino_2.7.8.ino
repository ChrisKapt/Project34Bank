...
// Stepper werkt door middel van stappen. (Dit moet sneller, maar doet wel het gevraagde aantal).
// Stepper werkt samen met Wire om de benodigde biljetten door te krijgen.
// Bon Printer werkt nog niet 100% samen met Wire voor de informatie.
